...
<!-- jQuery -->
	...
	<script type="text/javascript" src="/Portal/static/resources/js/training-comment.js"></script>
	...
	<link href="/Portal/static/resources/js/videojs/video-js.css" rel="stylesheet">
	<script type="text/javascript" src="/Portal/static/resources/js/videojs/video.js"></script>

	<script type="text/javascript">
		videojs.options.flash.swf="/Portal/static/resources/js/videojs/video-js.swf";
		$(function(){
	...
	<div class="autoHeight">
		...
		<div class="video-div" style="background-color: #000; height: 100%;">
			...
			<video id="my_video" class="video-js vjs-default-skin" controls preload="none" width="100%" height="100%" style="width:100%;height:100%;"
		      poster="/static/resources/images/bg.png"
		      data-setup="{}">
		      	<c:choose>
