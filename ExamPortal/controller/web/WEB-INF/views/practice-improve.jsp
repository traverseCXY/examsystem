...
<html>
	<head>
		...
		<link href="/Portal/static/resources/css/exam.css" rel="stylesheet" type="text/css">
	...
	<body>
					...
					<div class="col-xs-7" id="login-info">
						<c:choose>
							...
							<c:otherwise>
								...
								<a class="btn btn-success" href="/Portal/user/user-login-page">登录</a>
							</c:otherwise>
						</c:choose>
					</div>
				</div>
								...
								<ul class="comment-list">
									...
									<li class="comment-list-item">
										<div class="comment-user-container">
											<div >
												<img src="/static/resources/images/photo.jpg" class="comment-user-img">
											</div>
		...
		<script type="text/javascript" src="/Portal/static/resources/js/all.js?v=0712"></script>
		<script type="text/javascript" src="/Portal/static/resources/js/practice-improve.js"></script>
