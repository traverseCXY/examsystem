		...
		<div class="container">
			<ul class="nav nav-pills " style="margin: 20px 0;">
				<c:forEach items="${fieldList }" var="item">
					<li role="presentation" <c:if test="${item.fieldId == fieldId }"> class="active"</c:if>><a href="/Portal/student/practice-list?fieldId=${item.fieldId }">${item.fieldName }</a></li>
				</c:forEach>
			</ul>
			<div class="row">
				<div class="col-xs-6">
								...
								<tbody>
									<c:forEach items="${item.typeAnalysis }" var="tp">
										<tr>
											...
											<td><a href="/Portal/student/practice-improve/${fieldId }/${item.knowledgePointId }/${tp.questionTypeId }"
				...
				<div class="col-xs-6">
					...
					<a class="btn btn-success " href="/Portal/student/practice-test/${fieldId }">随机来20道 </i>
					</a>
				</div>
