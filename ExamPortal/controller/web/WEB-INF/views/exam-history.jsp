...
<html>
  <head>
	...
	<body>
				...
				<div class="row">
					<div class="col-xs-2">
						<ul class="nav default-sidenav">
							<li>
								<a href="/Portal/student/usercenter"> <i class="fa fa-dashboard"></i> 用户中心 </a>
							</li>
							<li>
												...
												<td>
													<c:choose>
														<c:when test="${item.approved == 3 or (item.examType == 3 and item.approved != 1)}">
															<a class="btn btn-success btn-sm" href="/Portal/student/student-answer-sheet/${item.examId }" target="_blank" title="预览">详细解答</a>
														</c:when>
													</c:choose>
		...
		<script type="text/javascript" src="/Portal/static/resources/js/exam-finished.js"></script>
	</body>
</html>