...
// 		
	...
	finishExam : function finishExam() {
		...
		var request = $.ajax({
			...
			type : "POST",
			url : "/Portal/student/practice-finished",
...
var modal = {
	prepare : function prepare() {
		$(".content").append("<div id=\"loading-progress\" style=\"display:none;\"><div id=\"loading-content\"> <h2>正在提交您的答案</h2><img class=\"loading-gif\" src=\"/static/resources/images/loading.gif\"/><div> </div>");
