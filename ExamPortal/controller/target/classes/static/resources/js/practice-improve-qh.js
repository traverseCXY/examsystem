...
//			modal.showProgress();
			...
			var request = $.ajax({
				...
				async:false,
				type : "POST",
				url : "/Portal/student/practice-improve",
...
//			examing.saveAnswerSheet();
	...
	loadStatus : function loadStatus(){
		...
		var request = $.ajax({
			...
			async:false,
			cache: false,
			url : "/Portal/student/practice-improve-his/" + fieldId + "/" + knowledgePointId + "/" + questionTypeId
		});
...
var modal = {
	prepare : function prepare() {
		$(".content").append("<div id=\"loading-progress\" style=\"display:none;\"><div id=\"loading-content\"> <h2>正在读取您的记录</h2><img class=\"loading-gif\" src=\"/Portal/static/resources/images/loading.gif\"/><div> </div>");
