...
<html>
	...
	<body>
		...
		<script type="text/javascript" src="/Portal/static/resources/js/practice-improve-qh.js"></script>
		<%--<script type="text/javascript" src="/static/resources/js/comment.js"></script>--%>
