...
<html>
  <head>
		...
		<!--[if lte IE 8]>
			<script type="text/javascript" src="/Portal/static/resources/chartjs/excanvas.js"></script>
		<![endif]-->
		<style>
			.table-striped a{
	...
	<body>
				...
				<div class="row">
					<div class="col-xs-2">
						<ul class="nav default-sidenav">
							...
							<li>
								<a href="/Portal/student/analysis"> <i class="fa fa-bar-chart-o"></i> 统计分析 </a>
							</li>
							<li>
								<a href="/Portal/student/exam-history"> <i class="fa fa-history"></i> 考试历史 </a>
							</li>
							<li>
								<a href="/Portal/student/training-history"> <i class="fa fa-book"></i> 培训历史 </a>
							</li>
		...
		<script type="text/javascript" src="/Portal/static/resources/js/echarts-all.js"></script>
		...
		$("#field-switch").change(function(){
			window.location.href="/Portal/student/usercenter/"+ $(this).val();
		});
