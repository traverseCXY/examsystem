...
<html>
  <head>
	...
	<body>
				...
				<div class="row">
					<div class="col-xs-2">
						<ul class="nav default-sidenav">
							<li>
								<a href="/Portal/student/setting"> <i class="fa fa-cogs"></i> 基本资料 </a>
							</li>
							<li class="active">
					...
					<div class="col-xs-10">
						...
						<div class="page-content row">
							<form class="form-horizontal" id="form-change-password" action="/Portal/student/change-pwd" style="margin-top:40px;" method="post">
		...
		<script type="text/javascript" src="/Portal/static/resources/js/pwd-change.js"></script>
	</body>
</html>