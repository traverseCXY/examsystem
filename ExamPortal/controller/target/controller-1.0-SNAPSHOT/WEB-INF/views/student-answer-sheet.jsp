...
<html>
  <head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link href="/Portal/static/resources/font-awesome/css/font-awesome.min.css" rel="stylesheet">
	...
	<body>
		<header>
			<div class="container">
				<div class="row">
					...
					<div class="logo">
						<h1>
							<a href="#"><%--<img alt="" src="/Portal/static/resources/images/logo.png">--%></a>
						</h1>
					</div>
				</div>
			...
			<div class="container">
				<nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
					<ul class="nav navbar-nav">
						...
						<li>
							<a href="/Portalstudent/practice-list"><i class="fa fa-edit"></i>试题练习</a>
						</li>
						<li>
							<a href="/Portalexam-list"><i class="fa  fa-paper-plane-o"></i>在线考试</a>
						</li>
						<li>
							<a href="/Portaltraining-list"><i class="fa fa-book"></i>培训资料</a>
						</li>
						<li class="active">
							<a href="/Portalstudent/usercenter"><i class="fa fa-dashboard"></i>会员中心</a>
						</li>
						<li>
							<a href="/Portalstudent/setting"><i class="fa fa-cogs"></i>个人设置</a>
						</li>
					</ul>
				</nav>
			</div>
				...
				<div class="row">
					<div class="col-xs-2">
						<ul class="nav default-sidenav">
							<li>
								<a href="/Portal/student/finish-exam/${examId }"> <i class="fa fa-bar-chart-o"></i> 分析报告 </a>

							</li>
							<li class="active">
								<a href="/Portal/student/student-answer-sheet/${examId }"> <i class="fa fa-file-text"></i> 详细解答 </a>
							</li>
						</ul>
					</div>
					<div class="col-xs-10">
		...
		<!-- Javascript files -->
		<!-- jQuery -->
		<script type="text/javascript" src="/Portal/static/resources/js/jquery/jquery-1.9.0.min.js"></script>
		<!-- Bootstrap JS -->
		<script type="text/javascript" src="/Portal/static/resources/bootstrap/js/bootstrap.min.js"></script>
		<script type="text/javascript" src="/Portal/static/resources/js/all.js"></script>
		<script type="text/javascript" src="/Portal/static/resources/js/exampaper-mark.js"></script>
		<script>
			$(function(){
