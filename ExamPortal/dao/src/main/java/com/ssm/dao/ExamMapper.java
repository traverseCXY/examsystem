...
public interface ExamMapper {
	 ...
	 * @return
	 */
	public List<ExamHistory> getUserExamHistByUserId(@Param("userId") int userId, @Param("array") int[] typeIdList);
	/**
	 * 根据id获取考试
	 * @param examId
	 * @return
	 ...
	 * @return
	 */
	public List<Exam> getExamListToApply(@Param("userId") int userId);
	 ...
	 * @return
	 */
	public List<Exam> getExamListToStart(@Param("userId") int userId, @Param("array") int[] typeIdList);
	 ...
	 * @return
	 */
	public List<Exam> getExamList(@Param("array") int[] idList);
}
