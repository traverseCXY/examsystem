			...
			$("#form-exampaper-add").submit(function() {
				...
				if (verify_result) {
					...
					$.ajax({
						...
						type : "POST",
						url :  "/Management/exampaper/exampaper-add",
						...
						success : function(message, tst, jqXHR) {
							...
							if (message.result == "success") {
								util.success("添加成功", function() {
									document.location.href = document.getElementsByTagName('base')[0].href + util.getCurrentRole() + '/exampaper-edit/' + message.generatedId;
								});
							} else {
