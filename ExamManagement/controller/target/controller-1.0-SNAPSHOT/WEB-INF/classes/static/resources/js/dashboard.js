...
var dashboard = {
	...
	loadInfo : function loadInfo() {
		$.ajax({
			...
			type : "GET",
			async : false,
			url : "/Management/dashboard/baseinfo",
	...
	loadStudentApprovedList : function loadStudentApprovedList() {
		$.ajax({
			...
			type : "GET",
			async : false,
			url : "/Management/dashboard/studentApprovedList",
	...
	loadStudentMarkList : function loadStudentMarkList() {
		$.ajax({
			...
			type : "GET",
			async : false,
			url : "/Management/dashboard/StudentMarkList",
			success : function(ehlist, tst, jqXHR) {
				if (!util.checkSessionOut(jqXHR))
					return false;
	...
	loadChart : function loadChart() {
		$.ajax({
			...
			type : "GET",
			async : false,
			url : "/Management/dashboard/chartinfo/" + $("#field-select").val(),
	...
	bindMark : function bindMark(){
		$(".mark-btn").click(function(){
			window.location.href =  "/Management/exam/mark-exampaper/" + $(this).data("id");
		});
	}
}; 