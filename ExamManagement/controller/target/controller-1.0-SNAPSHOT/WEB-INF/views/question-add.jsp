...
<html>
  <head>
	...
	<body>
					...
					<div class="col-xs-2" id="left-menu">
						<ul class="nav default-sidenav">
							...
							<li style="background: #0088cc;color: white">
								<a style="color: white" href="/Management/question/question-add" title="添加试题"><i class="fa fa-plus">&nbsp</i><span class="left-menu-item-name"> 添加试题</span></a>
							</li>
							<li>
						        ...
						        <div id="add-question-img-dialog" title="图片上传工具">
									 <form >
										...
										<div class="form-line add-update-quetstionfile">
											...
											<span class="form-message">请上传png、jpg图片文件，且不能大于100KB。为了使得图片显示正常，请上传的图片长宽比例为2:1<input id="file" type="file"/></span>
										</div>
									</form> 
								</div>
						      </div>
		...
		<script type="text/javascript" src="/Management/static/resources/js/question-upload-img.js"></script>
		<script type="text/javascript" src="/Management/static/resources/js/field-2-point.js"></script>
		<script type="text/javascript" src="/Management/static/resources/js/question-add.js"></script>
		<!-- Bootstrap JS -->
				...
				$.ajax({
							...
							success:function (result) {
								if (result.result = "success") {
									$("#imgSrc").attr("src",result.messageInfo);
									$(".fade").modal( 'hide');
								}
							}
						}
