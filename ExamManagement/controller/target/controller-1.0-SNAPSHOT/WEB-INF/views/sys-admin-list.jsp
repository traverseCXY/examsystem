...
<html>
	...
	<body>
				...
				<div class="row">
					<div class="col-xs-2" id="left-menu">
						<ul class="nav default-sidenav">
							<li>
								<a href="/Management/system/news-list" title="系统公告"><i class="fa fa-volume-up">&nbsp</i><span class="left-menu-item-name"> 系统公告</span></a>
							</li>
							<li style="background: #0088cc;color: white">
								<a style="color: white" href="/Management/system/admin-list" title="管理"><i class="fa fa-group">&nbsp</i><span class="left-menu-item-name"> 管理</span></a>
							</li>
						</ul>
					</div>
								...
								<div class="table-controller">
									<div class="btn-group table-controller-item" style="float:left">
										<button class="btn btn-default btn-sm" id="add-teacher-modal-btn">
											<i class="fa fa-plus-square"></i> 创建后台管理员账号
										</button>
									</div>
								</div>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h6 class="modal-title" id="myModalLabel">创建后台管理员账号</h6>
						</div>
						<div class="modal-body">
							<form id="teacher-add-form" style="margin-top:40px;"  action="/Management/system/add-admin">
						...
						<div class="modal-footer">
							...
							<button id="add-user-btn" data-action="/Management/system/add-admin" data-url="/Management/system/admin-list" data-group="0" type="button" class="btn btn-primary">
								确定添加
							</button>
						</div>
					</div>
		...
		<script type="text/javascript" src="/Management/static/resources/js/admin-list.js"></script>
		<script type="text/javascript" src="/Management/static/resources/js/add-admin.js"></script>
		<script type="text/javascript" src="/Management/static/resources/js/update-admin.js"></script>
		<script>
			$(function() {
