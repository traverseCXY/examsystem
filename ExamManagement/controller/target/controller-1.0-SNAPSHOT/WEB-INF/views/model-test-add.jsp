...
<html>
  <head>
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link href="/static/resources/css/question-add.css" rel="stylesheet">
		<link href="/static/resources/chart/morris.css" rel="stylesheet">
		<style>
	...
	<body>
					...
					<div class="col-xs-2" id="left-menu">
						<ul class="nav default-sidenav">
							...
							<li style="background: #0088cc;color: white">
								<a style="color: white" href="/Management/exam/model-test-add" title="发布模拟考试"><i class="fa fa-flag">&nbsp;</i><span class="left-menu-item-name"> 发布模拟考试</span></a>
							</li>
						</ul>
					</div>
		...
		<script type="text/javascript" src="/Management/static/resources/js/add-model-test.js"></script>
	</body>
</html>