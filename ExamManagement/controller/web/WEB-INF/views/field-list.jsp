...
<html>
  <head>
	...
	<body>
					...
					<div class="col-xs-2" id="left-menu">
						<ul class="nav default-sidenav">
							...
							<li style="background: #0088cc;color: white">
								<a style="color: white" href="/Management/common/field-list" title="专业题库"><i class="fa fa-anchor">&nbsp</i><span class="left-menu-item-name"> 专业题库</span></a>
							</li>
							<li>
								...
								<c:when test="${count > 10}">
									<div class="page-link-content" style="float: right;margin-left: 30px;">
										<ul class="pagination pagination-sm">
											<li><a  id="prev" class="${pageInfo.prePage}" href="/Management/common/field-list?pageNum=${pageInfo.prePage}">上一页</a> </li>
											<c:forEach items="${pageInfo.navigatepageNums}" var="page">
												<li><a  href="/Management/common/field-list?pageNum=${page}">${page}</a></li>
											</c:forEach>
											<li><a id="next" class="${pageInfo.nextPage}" href="/Management/common/field-list?pageNum=${pageInfo.nextPage}">下一页</a></li>
										</ul>
									</div>
								</c:when>
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form id="field-add-form" style="margin-top:40px;"  action="/Management/common/field-add">
		...
		<script type="text/javascript" src="/Management/static/resources/js/field-list.js"></script>
		<script type="text/javascript" src="/Management/static/resources/js/add-field.js"></script>
		<script>
