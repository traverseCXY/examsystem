...
<html>
  <head>
	...
	<body>
						  ...
						  <div class="modal-dialog modal-lg">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <iframe  id="qt-selector-iframe" src="/Management/question/question-list/filterdialog-0-0-0-0-1.html" width="100%"></iframe>
						      </div>
		...
		<script type="text/javascript" src="/Management/static/resources/js/exampaper-edit.js"></script>
