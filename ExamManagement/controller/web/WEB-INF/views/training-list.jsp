...
<html>
  <head>
	...
	<body>
					...
					<div class="col-xs-2" id="left-menu">
						<ul class="nav default-sidenav">
							<li style="background: #0088cc;color: white">
								<a style="color: white" href="/Management/training/training-list" title="培训管理"><i class="fa fa-list">&nbsp</i><span class="left-menu-item-name"> 培训管理</span></a>
							</li>
							<li>
								<a href="/Management/training/training-add" title="添加培训"><i class="fa fa-plus">&nbsp</i><span class="left-menu-item-name"> 添加培训</span></a>
							</li>
						</ul>
					</div>
		...
		<script type="text/javascript" src="/Management/static/resources/js/training-list.js"></script>
		<script type="text/javascript" src="/Management/static/resources/js/training-file-upload.js"></script>
		<script type="text/javascript" src="/Management/static/resources/js/add-training-section.js"></script>
		<script>
			$(function() {
