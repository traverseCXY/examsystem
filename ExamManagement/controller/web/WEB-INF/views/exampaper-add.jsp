  ...
  <head>
   ...
   <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<body>
				...
				<div class="row">
					<div class="col-xs-2" id="left-menu">
						<ul class="nav default-sidenav">
							<li>
								<a href="/Management/exampaper/exampaper-list" title="试卷管理"><i class="fa fa-list">&nbsp</i><span class="left-menu-item-name"> 试卷管理</span></a>
							</li>
							<li style="background: #0088cc;color: white">
								<a style="color: white" href="/Management/exampaper/exampaper-add" title="添加新试卷"><i class="fa fa-leaf">&nbsp</i><span class="left-menu-item-name"> 添加新试卷</span></a>
							</li>
						</ul>
					</div>
		...
		<script type="text/javascript" src="/Management/static/resources/js/exampaper-add.js"></script>
